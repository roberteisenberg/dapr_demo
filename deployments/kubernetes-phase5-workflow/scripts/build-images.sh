...
docker build -t workflow-service:latest -f workflow-service/Dockerfile workflow-service/
...
echo ""
echo "Images built:"
docker images | grep -E "(catalog|order|notification|workflow)-service|web-app" | head -10
echo ""
